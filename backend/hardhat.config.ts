...
// Support environment variables (PowerShell: $env:MNEMONIC, bash: $MNEMONIC)
// Hardhat vars also supports HARDHAT_VAR_MNEMONIC format
...
// Support custom Sepolia RPC URL
